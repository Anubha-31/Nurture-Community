    ...
    <div class="container mx-auto px-6 py-3">
      <form @submit.prevent="formSubmit">
        <div class="mt-6 space-y-3 md:w-2/5 md:mx-auto">
          ...
          <div class="pt-4 flex">
            <button type="submit" class="py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-1/2">
              Search
            </button>
            <button type="button" v-on:click="reset" class=" py-2 px-4 ml-5 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-1/2">
              Reset
            </button>
          </div>
        </div>
